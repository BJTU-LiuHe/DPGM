...
num_batch_ge = 10
KEEPPROB_ENCODER = GM_GenData.KEEPPROB_ENCODER_CUB
KEEPPROB_DECODER = GM_GenData.KEEPPROB_DECODER_CUB
KEEPPROB_CONV=GM_GenData.KEEPPROB_CONV_CUB
MEAN_POOLING_INT = GM_GenData.MEAN_POOLING_INTERVAL_CUB
LATENT_DIM=GM_GenData.LATENT_DIM_CUB
REGULAR_RATE = GM_GenData.REGULAR_RATE_CUB
