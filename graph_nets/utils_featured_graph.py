...
NODE_PATCHES_1 = graphs.NODE_PATCHES_1
NODE_PATCHES_2 = graphs.NODE_PATCHES_2
...
GRAPH_NX_NODE_PATCHES_1 = "patches1"
GRAPH_NX_NODE_PATCHES_2 = "patches2"
...
class FeaturedGraph :
  def __init__(self, node_features, edge_features, attr_dicts):
  ...
  def graph_to_data_dict(self,
    ...
    n_batch = np.zeros((number_of_groups_1,), dtype=np.int32)
    ...
    if GRAPH_NX_GROUP_FEATURE_1 in self._attr_dicts:
      groups_1 = self._attr_dicts[GRAPH_NX_GROUP_FEATURE_2]#GRAPH_NX_GROUP_FEATURE_2

    groups_2 = None
    if GRAPH_NX_GROUP_FEATURE_2 in self._attr_dicts:
      groups_2 = self._attr_dicts[GRAPH_NX_GROUP_FEATURE_2]#GRAPH_NX_GROUP_FEATURE_2
    # ==========  added finish ===============================

    # ==========  added by wangtao, for image patches of nodes ==========
    patches1 = None
    if GRAPH_NX_NODE_PATCHES_1 in self._attr_dicts:
      patches1 = self._attr_dicts[GRAPH_NX_NODE_PATCHES_1]

    patches2 = None
    if GRAPH_NX_NODE_PATCHES_2 in self._attr_dicts:
      patches2 = self._attr_dicts[GRAPH_NX_NODE_PATCHES_2]
    # ==========  added finish ===============================
    ...
    return {
        ...
        GROUPS_2: groups_2,
        NODE_PATCHES_1: patches1,
        NODE_PATCHES_2: patches2,
        N_BATCH: n_batch
    }
...
def _concatenate_data_dicts(data_dicts):
  ...
  if concatenated_dicts[N_BATCH] is not None:
    offset = 0
    for idx in range(len(concatenated_dicts[N_BATCH])):
      concatenated_dicts[N_BATCH][idx] += offset
      offset +=1
