...
def placeholders_from_weighted_graphs(graphs,
  ...
  """
  with tf.name_scope(name):
    graph = utils_featured_graph.featured_graphs_to_graphs_tuple(graphs, node_shape_hint,
                                               edge_shape_hint,
...
#  utils_np._check_valid_sets_of_keys([gr._asdict() for gr in input_graphs])  # pylint: disable=protected-access
  utils_featured_graph._check_valid_sets_of_keys([gr._asdict() for gr in input_graphs])  # pylint: disable=protected-access
...
#  utils_np._check_valid_sets_of_keys(data_dicts)  # pylint: disable=protected-access
  utils_featured_graph._check_valid_sets_of_keys(data_dicts)  # pylint: disable=protected-access
  with tf.name_scope(name):
