...
GRAPH_FEATURE_FIELDS = (NODES, EDGES, GLOBALS, GROUPS_1, GROUPS_2)
GRAPH_INDEX_FIELDS = (RECEIVERS, SENDERS, GROUP_INDICES_1,GROUP_INDICES_2)
GRAPH_DATA_FIELDS = (NODES, EDGES, RECEIVERS, SENDERS, GLOBALS, GROUP_INDICES_1, GROUP_INDICES_2, GROUPS_1, GROUPS_2, \
                     NODE_PATCHES_1, NODE_PATCHES_2, N_BATCH)
GRAPH_NUMBER_FIELDS = (N_NODE, N_EDGE, N_GROUP_1, N_GROUP_2)
ALL_FIELDS = (NODES, EDGES, RECEIVERS, SENDERS, GLOBALS, N_NODE, N_EDGE, N_GROUP_1, GROUP_INDICES_1, GROUPS_1, \
              N_GROUP_2, GROUP_INDICES_2, GROUPS_2, NODE_PATCHES_1, NODE_PATCHES_2, N_BATCH)
