...
#    output_ops_tr = model(input_ph, num_processing_steps_tr)
    ...
    return sess, input_ph, target_ph, loss_cof_ph, output_ops_ge
...
model_file = "trained_models/Pascal/Pascal_preVGG16-lr=0.0003-35650"
#model_file = "trained_models/Pascal_LfNet-lr=0.001-89950"
sess, input_ph, target_ph, loss_cof_ph, output_ops_ge = load_trained_model(model_file)
...
# evaluate_Willow(sess, input_ph, target_ph, loss_cof_ph, output_ops_ge)
evaluate_VOC(sess, input_ph, target_ph, loss_cof_ph, output_ops_ge)