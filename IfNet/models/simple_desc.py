...
from IfNet.common.tf_layer_utils import *
from IfNet.common.tf_train_utils import get_activation_fn
from IfNet.det_tools import instance_normalization
...
def get_model(inputs, is_training, 
    ...
    with tf.variable_scope(name, reuse=reuse) as net_sc:
        ...
        # #removed by wangtao, reduce FCL to only one layer
        # num_hidden = 512
        # curr_in = fully_connected(curr_in, num_hidden, scope='fc1',
        #                           use_xavier=use_xavier, use_bias=use_bias)
        # curr_in = batch_norm_act(curr_in, activation_fn,
        #                          perform_bn=perform_bn,
        #                          is_training=is_training,
